...
try:
    ...
    py3 = True
def click_checkinn():
    call(["python", "NewCustomer.py"])
def click_list():
    call(["python", "CustomerList.py"])
def click_checkout():
    call(["python", "checkoutgui.py"])
def click_getinfo():
    call(["python","getinfoui.py"])
def click_timeclock():
    call(["python","timeclock.py"])
def click_schedu():
    call(["python","easySchedule.py"])
...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        self.Frame1.configure(width=71)
        ...
        self.Message6.configure(text='Customer System')
        self.Message6.configure(width=400)

        self.Button2 = Button(self.Frame1)
        self.Button2.place(relx=0.18, rely=0.17, height=93, width=250)
        ...
        self.Button2.configure(text='New Customer')
        self.Button2.configure(width=71)
        self.Button2.configure(command=click_checkinn)

        self.Button3 = Button(self.Frame1)
        self.Button3.place(relx=0.18, rely=0.33, height=93, width=250)
        ...
        self.Button3.configure(text='Customer List')
        self.Button3.configure(width=71)
        self.Button3.configure(command=click_list)

        self.Button4 = Button(self.Frame1)
        self.Button4.place(relx=0.18, rely=0.47, height=93, width=250)
        ...
        self.Button5.place(relx=0.18, rely=0.60, height=93, width=250)
        ...
        self.Button5.configure(text='Time Clock')
        self.Button5.configure(width=71)
        self.Button5.configure(command=click_timeclock)

        self.Button7 = Button(self.Frame1)
        self.Button7.place(relx=0.18, rely=0.70, height=93, width=250)
        ...
        self.Button7.configure(text='Scheduler')
        self.Button7.configure(width=71)
        self.Button7.configure(command=click_schedu)

        self.Button6 = Button(self.Frame1)
        self.Button6.place(relx=0.18, rely=0.80, height=93, width=250)
        ...
        self.Button6.configure(width=71)
